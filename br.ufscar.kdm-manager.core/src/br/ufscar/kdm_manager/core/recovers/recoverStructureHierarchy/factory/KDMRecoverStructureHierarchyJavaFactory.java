...
public interface KDMRecoverStructureHierarchyJavaFactory {
	...
	KDMRecoverGenericStructureHierarchy<String> createRecoverStructureHierarchyComplete();
	
	KDMRecoverGenericStructureHierarchy<String> createRecoverStructureHierarchyModel();
